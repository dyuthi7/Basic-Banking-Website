...
h2,p{
    ...
    td,th { border: 2px solid #ddd; padding: 8px;}
    #Table{ font-family: Arial,Helvetica, sans-serif; border-collapse: collapse;}
    #Table tr:nth-child(even){ background-color: #F0FFFF; }
    #Table tr:nth-child(odd){ background-color: #F0FFF0; }
    #Table tr:hover{ background-color: #a0a9e7; }
...
<?php 
  if(isset($_POST['form_submitted'])){
    ...
    //These variables are collecting form data
      ...
      //BELOW CODE RUNS WHEN ALL DETAILS ENTERED BY USER ARE CORRECT OR NOT
          ...
          echo " <div class='des'><h2 style='text-align: center'>Transaction Successfully Completed</h2><br>
  ...
  //IF ENDS HERE    
      ...
      ?>
      <h1><center><strong><br><br><br><br><br><br><br><br><br><br>All transactions are upto date</strong></center></h1>
      <?php
  }
